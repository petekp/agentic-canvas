...
const morningBriefingTemplate: TemplateDefinition = {
  ...
  parameters: [
    ...
    { key: "posthogProperties", type: "json", default: [] },
    { key: "posthogTimeWindow", type: "string", default: "7d" },
    { key: "posthogTopPagesLimit", type: "number", default: 5 },
  ],
  constraints: {
    preferredAspect: "wide",
    ...
    components: [
      {
        ...
        config: {
          ...
          posthogTimeWindow: "$posthogTimeWindow",
          posthogTopPagesLimit: "$posthogTopPagesLimit",
        },
        dataBinding: {
          source: "briefing",
          query: {
