 ...
 * Every tool UI should have a unique identifier.
 * Format: `{component-type}-{semantic-identifier}`
 * Examples: "stats-open-prs", "stats-repo-health"
 */
export const ToolUIIdSchema = z.string().min(1);
export type ToolUIId = z.infer<typeof ToolUIIdSchema>;

/**
 * Primary role of a Tool UI surface in a canvas context.
 */
